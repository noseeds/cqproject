...
<head>
    ...
    <script>
        function moveBoxes(offset) {
            document.getElementById('sliderValue').textContent = offset;
            document.getElementById('box1').style.left = offset + 'px';
            document.getElementById('box2').style.left = (100 + parseInt(offset)) + 'px';
            document.getElementById('box3').style.left = (200 + parseInt(offset)) + 'px';
        }
    </script>
...
<body>
    ...
    <nav>
        ...
        <a href="#contacto" class="scroll"> Sobre Nosotros </a>
        <a href="#sobre_nosotros" class="scroll"> Contacto </a>
